...
import { Avatar, Button, Select, MenuItem, MenuList } from "@mui/material";
...
export default function Navigation() {
  ...
  // useEffect(()=>{
  //      if(!anchorEl){
  //          document.addEventListener("mousedown", handleUsercloseClick())
  //      }
  // },[anchorEl])
  ...
  return (
    <div className="bg-white">
      ...
      <Dialog
        open={open}
        onClose={setOpen}
        className="relative z-1090 lg:hidden"
      >
        <DialogBackdrop
          transition
      ...
      <AuthModal handleClose={handleClose} open={authModelopen} />
    </div>
  );
}
