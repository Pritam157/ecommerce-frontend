...
export const orderReducer=(state =initialState,action)=>{
    ...
    switch (action.type) {
        ...
        case GET_ORDER_PLACED_REQUEST:
            return {...state,loading:true,error:null}
        case GET_ORDER_PLACED_SUCCESS:
            return {...state,loading:false,success:true,order:action.payload,error:null}
        case GET_ORDER_PLACED_FAILURE:
            return {...state,loading:false,error:action.payload}
        ...
        case GET_ORDER_HISTORY_SUCCESS:
            return {...state,loading:false,orders:action.payload,success:true,error:null}
