...
export const GET_ORDER_PLACED_REQUEST='GET_ORDER_PLACED_REQUEST'
export const GET_ORDER_PLACED_SUCCESS='GET_ORDER_PLACED_SUCCESS'
export const GET_ORDER_PLACED_FAILURE='GET_ORDER_PLACED_FAILURE'
